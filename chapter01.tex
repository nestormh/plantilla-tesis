...
Some examples of this kind of methods are the following:
\begin{itemize}
 \item In \cite{kuwata2008motion}, a tree of trajectories is sampled simulating the closed loop system using the \acf{RRT} algorithm.
 \item lavalle1998rapidly
 \item van1997real
\end{itemize}
