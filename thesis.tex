...
% \documentclass[a4paper,oneside,11pt,DIV=15]{scrbook}
...
\bibpunct{(}{)}{;}{a}{,}{,}
\setbibpreamble{The following references are author-ordered.\par\bigskip}
...
\usepackage[
  ...
  pdfkeywords={Obstacle Detection and Tracking, Path Planning, Autonomous Vehicles, Image Registration, Background Removal, Non Rigid Point Set Registration, Stereo Vision, Long Sequences Automatic Evaluation, Stixel World, Particle Filter, Voxelization, Support Vector Machines, Multiclass Support Vector Machines, Trajectory Generation, Local Path Planner, Frenét Space}
  ]{hyperref}
...
\frontmatter
\label{frontpage}\pdfbookmark{Front Page}{frontpage}
\titlehead{
