...
\begin{frame}{Local planning}
 \begin{figure}
  \includemovie[autoplay, repeat, controls]{\textwidth}{0.8\textheight}{/home/nestor/Seafile/Videos/Tesis/cp07/toma_mortal.mp4}
 \end{figure}
\end{frame}

\begin{frame}{Local planning}
 \begin{figure}
  \includemovie[autoplay, repeat, controls]{\textwidth}{0.8\textheight}{/home/nestor/Seafile/Videos/Tesis/cp07/dos_personas.mp4}
 \end{figure}
\end{frame}

\begin{frame}{Local planning}
 \begin{figure}
  \includemovie[autoplay, repeat, controls]{\textwidth}{0.8\textheight}{/home/nestor/Seafile/Videos/Tesis/cp07/pickup.mp4}
 \end{figure}
\end{frame}
