...
\begin{frame}{Pipeline}
  \begin{center}
    \includegraphics{pipeline_general_cp05}
  \end{center}
  \note{
  \begin{enumerate}
    ...
    \item \emph{Voxel pose and speed computation.} Based on a \ac{PF} and in the probabilities assigned in the previous step, we calculate the pose and speed of each of the voxels in the grid.
...
\begin{frame}{Particle Filter based Object Tracking}
  \begin{columns}
    \column{0.5\textwidth}
      \includemovie[autoplay, repeat, controls]{\textwidth}{0.5\textheight}{/home/nestor/Seafile/Videos/Tesis/cp03/ncc.avi}
    \column{0.5\textwidth}
      \includemovie[autoplay, repeat, controls]{\textwidth}{0.5\textheight}{/home/nestor/Seafile/Videos/Tesis/cp03/ncc.avi}
  \end{columns}
\end{frame}
